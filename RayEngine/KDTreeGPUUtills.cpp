...
int RKDTreeNodeGPU::GetLeftIndex() const
{
	return left_index;
}

int RKDTreeNodeGPU::GetRightIndex() const
{
	return right_index;
}

int RKDTreeNodeGPU::GetIndexOfFirstObject() const
{
	return index_of_first_object;
}

int RKDTreeNodeGPU::GetNumObjs() const
{
	return num_objs;
}
