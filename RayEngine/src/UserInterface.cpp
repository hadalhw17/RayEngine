...
//
//
//void RUserInterface::render_main_hud(bool show_menu, struct TerrainBrush& brush, float& character_speed, struct RenderingSettings& render_settings, struct SceneSettings& scene_settings, struct float3 curr_pos)
//{
//	if (!show_menu)
//	{
//		bool overlay;
...
//	else
//	{
//		render_menu(brush, character_speed, render_settings, scene_settings, curr_pos);
//	}
//
//}
//
...
//void RUserInterface::render_menu(TerrainBrush &brush, float &character_speed, struct RenderingSettings& render_settings, struct SceneSettings &scene_settings, float3 curr_pos)
//{
//	ImGui_ImplOpenGL3_NewFrame();
//	ImGui_ImplGlfw_NewFrame();
//	ImGui::NewFrame();
